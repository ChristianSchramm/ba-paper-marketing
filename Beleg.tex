...
% **************************************************
\newcommand{\thesisTitle}{Suchmaschinenmarketing}
\newcommand{\thesisSubtitle}{Suchmaschinenmarketing Untertitel}
\newcommand{\thesisName}{Christian Schramm}
\newcommand{\thesisMatrikel}{s3001102}
\newcommand{\thesisSubject}{Belegarbeit Marketing}
\newcommand{\thesisDate}{April 8, 2014}
\newcommand{\thesisVersion}{0.0.1}

\newcommand{\thesisFirstReviewer}{Stefan Pabst}
% \newcommand{\thesisFirstReviewerUniversity}{\protect{webit! Gesellschaft für neue Medien mbH}}
\newcommand{\thesisFirstReviewerDepartment}{webit! Gesellschaft für neue Medien mbH}
...
\input{Inhalt/Einleitung} % INCLUDE: introduction
\input{Inhalt/Grundlagen} % INCLUDE: Grundlagen
\input{Inhalt/Betrachtungsbeispiel} % INCLUDE: Betrachtungsbeispiel
...
\input{Inhalt/Fazit} % INCLUDE: conclusion
\cleardoublepage
...
\input{Inhalt/Selbstständigkeitserklärung}
\clearpage
\newpage
\mbox{}
